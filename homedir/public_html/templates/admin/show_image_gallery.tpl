<div class="box_data" >
	...
	<tr class="data"> 
		...
		<td valign="top"> {$image_album_detail[$smarty.section.data.index].album_title|truncate:30:'...':TRUE}</td> 
				<td valign="top"> 
			<a href="admin.php?view=image_gallery&action=set_gallery&image_id={$image_album_detail[$smarty.section.data.index].ad_id}&set=
		...
		<form name="del_form" method="post" enctype="multipart/form-data" action="admin.php?view=image_gallery&action=del_gallery">
		 <a href="admin.php?view=image_gallery&action=edit_gallery&image_id={$image_album_detail[$smarty.section.data.index].ad_id}">Edit</a> 
