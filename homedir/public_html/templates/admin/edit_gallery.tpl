<div class="dv_header">Edit {$gal_title}</div>
<div style="margin:4px; border:#0099FF solid; padding:4px; vertical-align:top;">	
	<form action="admin.php?view={$gallery}&action=edit_gallery" name="edit_gallery" enctype="multipart/form-data" method="post">
