...
<div style="margin:4px; border:#0099FF solid; padding:4px; vertical-align:top;">	
	...
	<tr class="form_tmpl_2"> 
		...
		<td valign="top" width="65%"> <input type="text" size="50"  name="title" value="{$news_data[0].article_title}"  /> </td>
  	 	<td valign="top"><div id="title"></div></td>	 
	</tr>
	<tr class="form_tmpl_2"> 
		<td align="right" valign="top"><strong> Description </strong></td> 
		<td valign="top"> <textarea name="desc" rows="8" cols="75" >{$news_data[0].article_desc}</textarea> </td>
	...
	{if $news_data[0].image_position=='R'} checked="checked" {/if} />Right	
	...
	<tr class="form_tmpl_2">
		...
		<tr class="form_tmpl_2">
		<td valign="top" colspan="3" align="center"><div  style="background-image:url(news_images/{$news_data[0].article_image}); background-repeat:no-repeat; background-position:center; padding:2px; width:{$width}px; max-width:950px; height:{$height}px; ">&nbsp;</div></td>
	</tr>

	<tr class="form_tmpl_2">
	<td valign="top" colspan="3" align="center">
	<input type="hidden" name="article_id" value="{$news_data[0].article_id}" > 
	<input type="hidden" name="article_image" value="{$news_data[0].article_image}" > 
