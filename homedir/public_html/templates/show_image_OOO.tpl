<div id="testMain">
	<p class="testtop"></p>
		<div id="test">
		<h2><span>Detail of Gallery</span></h2>
...
<div class="main_content_demo">
    ...
    {section name=imgdata loop=$image}
		<div class="demo"><a href="{$site_url}album_image_gallery/{$image[imgdata].ad_data}" class="pirobox" title="{$image[imgdata].ad_title}"><img src="{$site_url}album_image_gallery/{$image[imgdata].ad_data}" alt="{$image[imgdata].ad_data}"  /></a></div>
    {/section}
	</div>
</div>
<br class="spacer" />
