<?php /* Smarty version 2.6.22, created on 2013-06-29 12:13:53
         compiled from admin/print_view_guest.tpl */ ?>
	<table border="0"  width="90%" align="center" >
    <tr><td colspan="3" height="30px"></td></tr>
    <tr>
    	<td colspan="3" style="text-align:center; font-size:22px; font-weight:bold;">Yuva Muslim Seva Simiti</td>
    </tr>
    <tr>
    	<td colspan="3" style="text-align:center; font-size:22px; font-weight:bold;">Nohar (Hanumangarh)</td>
    </tr>
...
" width="100px" height="100px" /></td>
    ...
    <tr>
    	<td width="8%" style="padding-left:25px">Name</td>
        <td width="5%">:</td>
