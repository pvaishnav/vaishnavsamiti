<?php /* Smarty version 2.6.22, created on 2014-03-17 19:07:27
         compiled from admin/edit_album.tpl */ ?>
<div style="margin:4px; border:#0099FF solid; padding:4px; vertical-align:top;">	
	...
	<tr class="form_tmpl_2"> 
		...
		<td valign="top" width="65%"> <input type="text" name="title" size="50" value="<?php echo $this->_tpl_vars['album_data'][0]['album_title']; ?>
"  /> </td>
  	 	<td valign="top"><div id="title"></div></td>	 
	</tr>
	<tr class="form_tmpl_2"> 
		<td align="right" valign="top"><strong> Description </strong></td> 
		<td valign="top"> <textarea name="desc" rows="8" cols="75" ><?php echo $this->_tpl_vars['album_data'][0]['album_desc']; ?>
</textarea> </td>
		<td valign="top"><div id="desc"></div></td>		
	</tr>
	<tr class="form_tmpl_2">	
		<td align="right" valign="top"><strong> Album Type </strong> </td> 
		<td valign="top"> <input type="text" name="type" size="50" value="<?php echo $this->_tpl_vars['album_data'][0]['cat_name']; ?>
" readonly="1"  /> 
		</td>
	...
	<tr class="form_tmpl_2">
		<td align="right" valign="top"><strong>  Album Image </strong></td> 
  	    <td valign="top"> <input type="file" size="50" name="image_browse" value="<?php echo $this->_tpl_vars['album_data'][0]['album_image']; ?>
 " /> 
		<td valign="top"><div id="image_browse"></div></td>
	</tr>

	<tr class="form_tmpl_2">
		<td valign="top" colspan="3" align="center"><div  style="background-image:url(album_images/<?php echo $this->_tpl_vars['album_data'][0]['album_image']; ?>
...
px; ">&nbsp;</div></td>
	...
	<input type="hidden" name="album_id" value="<?php echo $this->_tpl_vars['album_data'][0]['album_id']; ?>
" > 
	<input type="hidden" name="album_image" value="<?php echo $this->_tpl_vars['album_data'][0]['album_image']; ?>
" > 
