<?php /* Smarty version 2.6.22, created on 2014-10-03 02:53:13
         compiled from show_ecard.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'show_ecard.tpl', 9, false),array('modifier', 'strip_tags', 'show_ecard.tpl', 10, false),)), $this); ?>
<div id="testMain">
	<p class="testtop"></p>
		<div id="test">
...
?>
		<div class="demo"><a href="<?php echo $this->_tpl_vars['site_url']; ?>
index.php?page=rd_ecard&action=send_ecard&id=<?php echo $this->_tpl_vars['image'][$this->_sections['imgdata']['index']]['ad_id']; ?>
"><img src="<?php echo $this->_tpl_vars['site_url']; ?>
album_ecard_gallery/<?php echo $this->_tpl_vars['image'][$this->_sections['imgdata']['index']]['ad_data']; ?>
